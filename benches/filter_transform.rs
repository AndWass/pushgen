...
pub fn benchmarks(c: &mut Criterion) {
    ...
    c.bench_function("iterator_filter_transform", |b| b.iter(|| run_iterator(black_box(&data))));
    c.bench_function("generator_filter_transform", |b| b.iter(|| run_generator(black_box(&data))));
}
